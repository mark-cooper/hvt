...
namespace :db do
  ...
  task populate_sample_data: :environment do
    r = Record.create!({
      ...
      summary_by: Faker::Name.name,
      summary_date: random_date(-365),
      cataloged_by: Faker::Name.name,
      cataloged_date: random_date(-365),
      input_by: Faker::Name.name,
      input_date: random_date(-365),
      edited_by: Faker::Name.name,
      edited_date: random_date(-365),
      corrected_by: Faker::Name.name,
      corrected_date: random_date(-365),
      produced_by: Faker::Name.name,
